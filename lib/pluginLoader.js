...
function getTargetPlugins(pluginStore, pluginDeps) {
    ...
    const plugins = packageLoader.getPackages([pluginsPathPattern, ignorePattern], constructPluginConfig)
...
function getAllPlugins(pluginStore) {
    ...
    return packageLoader.getPackages([pluginsPathPattern, ignorePattern], constructPluginConfig)
}
 ...
 * @returns {Object}
 */
function constructPluginConfig(rawPlugin) {
